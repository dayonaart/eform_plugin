...
class TabunganController extends GetxController {
  ...
  void saveTabungan() {
    ...
    if (activeTabIndex == 0) {
      newTabungan = Tabungan('Taplus Digital', '2000-0001', '', '', '');
      print(newTabungan.produk);
      preferencesTabungan.saveTabungan(newTabungan, prefs!);
    } else if (activeTabIndex == 1) {
      newTabungan = Tabungan(
          'Taplus Muda Digital', '2003-1001', '13', '1', 'BNI Card Silver Virtual');
      preferencesTabungan.saveTabungan(newTabungan, prefs!);
      print(newTabungan.produk);
    } else if (activeTabIndex == 2) {
      newTabungan = Tabungan('Taplus Bisnis Digital', '2300-0001', '19', '2',
