...
class PerkerjaanController extends GetxController {
  ...
  getStringValuesSF() async {
    ...
    selectedTransactionEstimation =
        prefs!.getString("perkiraanNilaiTransaksi")!;
    ...
    if (selectedJob != '') {
      ...
      index = sourceOfFundList
          .indexWhere((element) => element.id == selectedSourceOfFund);
      ...
      index = openAccReasonList
          .indexWhere((element) => element.id == selectedOpenAccReason);
