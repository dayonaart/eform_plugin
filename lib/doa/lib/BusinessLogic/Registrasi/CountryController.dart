...
class CabangController extends GetxController {
  ...
  Future getStringValuesSF() async {
    ...
    if (selectedProvinsi != "") {
      index = listProvinsi
          .indexWhere((element) => element["id"] == selectedProvinsi);
      provinsiController.text = listProvinsi[index]['provinsi'];
      index =
          listKota.indexWhere((element) => element["idkota"] == selectedKota);
      kotaControllers.text = listKota[index]['kota'];
      index = listkantor
          .indexWhere((element) => element["kodeoutlet"] == selectedKantor);
