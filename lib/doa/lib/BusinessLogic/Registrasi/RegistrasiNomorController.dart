...
class RegistrasiNomorController extends GetxController {
  ...
  TextEditingController dialCodePhoneNumber =
  ...
  Future saveCountry(int selectedIndex) async {
    ...
    preferences.setString(
        'selectedFlagCountry', flagUrl[indexResult[selectedIndex]]);
    preferences.setString(
        'selectedCountryName', nameCountry[indexResult[selectedIndex]]);
    preferences.setString(
        'dialCodeNegara', dialCode[indexResult[selectedIndex]]);
  ...
  Future loadCountryJson() async {
    ...
    if (object.length != 0) {
      ...
      for (var i = 0; i < object.length; i++) {
        ...
        flagUrl.add(
            "assets/images/bendera/${object[i]['code']}.png".toLowerCase());
  ...
  Future saveSharedPref() async {
    ...
    if (bodyNumberPhone.text.isNotEmpty) {
      ...
      preferences.setString(
          'dialCodeNegara', dialCodePhoneNumber.text.substring(1));
  ...
  Future getCountryName() async {
    try {
      ...
      country =
          placemarks[0].country.toString(); // this will return country name
