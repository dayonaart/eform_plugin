...
class _CustomIntlDialogState extends State<CustomIntlDialog> {
  RegistrasiNomorController registrasiNomorController =
            ...
            children: [
                  ...
                  if (value.isNotEmpty) {
                    ...
                    tempDataList.forEach((element) {
                      if (element.contains(value)) {
                        tempData.add(tempDataList.indexWhere(
              ...
              Expanded(
                child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: data.search.text == ''
                        ? data.object.length
                        : data.indexResult.length,
                          ...
                          ? GestureDetector(
                              ...
                              child: Card(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(data.flagUrl[index],
                                            fit: BoxFit.fill,
                                            package: "eformplugin"),
                                      ),
                                  ...
                                  Flexible(
                                      child: Text(data.nameCountry[index])),
