...
import 'package:eformplugin/doa/lib/src/components/custom_intl_phone/custom_intl_dialog.dart';
import 'package:eformplugin/doa/lib/src/components/custom_intl_phone/models_intl/custom%20_country_controller.dart';
        ...
        children: [
          SizedBox(
            ...
            child: InkWell(
              onTap: (() {
                showDialog(
                    context: context, builder: (_) => CustomIntlDialog());
              }),
              child: Row(
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(widget.pathUrlFlag,
                          fit: BoxFit.fill, package: "eformplugin"),
                    ),
                  ),
                  SizedBox(
                    width: 8,
