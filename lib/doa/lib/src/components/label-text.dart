...
//label style - sam
TextStyle labelText =
    blacktext.copyWith(fontWeight: FontWeight.w500, fontSize: 14, height: 2);
...
TextStyle labelTextBlueBold = blacktext.copyWith(
    ...
    color: Color(0xff005E6A));
TextStyle errorTextRed = blacktext.copyWith(
    fontSize: 12, height: 1.5, fontWeight: FontWeight.w600, color: Colors.red);
...
TextStyle headerContentText =
    blacktext.copyWith(fontWeight: FontWeight.w400, fontSize: 14);
