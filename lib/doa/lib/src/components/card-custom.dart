                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextButton(
                              onPressed: () async =>
                                  await detailTapPlusDialog(title),
                              child: Text(
                                buttonText,
                                style: whiteText.copyWith(
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        if (title.toLowerCase() == "taplus digital") ...[
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              rowtext("Setoran Awal", "Minimum Rp50.000,-", 1),
                              rowtext("Minimum Setoran Selanjutnya",
                                  "Rp5.000,-", 2),
                              rowtext("Minimum Saldo rata-rata per bulan",
                                  "Rp50.000,-", 2),
                              rowtext("Denda dibawah Saldo Minimum",
                                  "Rp5.000,-", 2),
                              rowtext(
                                  "Biaya Pengelolaan Rekening Per bulan",
                                  "Bebas biaya selama 6 bulan pertama. Bulan selanjutnya dikenakan biaya sebesar Rp11.000,-/bulan",
                                  1),
                              rowtext("Biaya Penggantian Buku", "Rp1.500,-", 2),
                              rowtext(
                                  "Biaya Penutupan Rekening", "Rp10.000,-", 2),
                              rowtext("Biaya Administrasi Kartu Debit",
                                  "Rp4.000,-", 2),
                              Divider(thickness: 2),
                              Padding(
                                padding:
                              ...
                              rowtext("Tunggakan Biaya Administrasi",
                                  "Maksimal 3x tunggakan", 2),
                              rowtext("Tunggakan Denda di bawah Saldo Minimum",
                                  "Maksimal 3x tunggakan", 2),
                              rowtext("Tunggakan Biaya Administrasi Kartu",
                                  "Rp10.000,-", 2),
                              Divider(thickness: 2),
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 16, bottom: 16),
                                child: Text("Fasilitas Transaksi",
                                    style: semibold12),
                              ),
                              listedText(
                              ...
                              listedText(
                                  "Limit transaksi belanja sampai Rp 10 juta/hari"),
                              listedText(
                          ...
                          Column(
                            children: [
                              ...
                              rowtext(
                                  "> Rp 50 Juta s/d Rp 500 Juta", "0.20%", 1),
                              rowtext(
                                  "> Rp 500 Juta s/d Rp 1 Milyar", "0.60%", 1),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              rowtext("Minimum Saldo rata-rata per bulan",
                                  "Rp0,-", 2),
                              rowtext(
                                  "Denda dibawah Saldo Minimum", "Rp0,-", 2),
                              rowtext(
                                  "Biaya Pengelolaan Rekening Per bulan",
                                  "Bebas biaya selama 6 bulan pertama. Bulan selanjutnya dikenakan biaya sebesar Rp5.000,-/bulan",
                                  1),
                              rowtext("Biaya Penggantian Buku", "Rp1.500,-", 2),
                              rowtext(
                                  "Biaya Penutupan Rekening", "Rp50.000,-", 2),
                              rowtext("Biaya Administrasi Kartu Debit",
                                  "Rp4.000,-", 2),
                              Divider(thickness: 2),
                              Padding(
                          ...
                          Column(
                            children: [
                              ...
                              rowtext(
                                  "> Rp 10 Juta s/d Rp 50 Juta", "0.50%", 1),
                              rowtext(
                                  "> Rp 50 Juta s/d Rp 100 Juta", "0.75%", 1),
                          ...
                          Column(
                            ...
                            children: [
                              rowtext(
                                  "Setoran Awal", "Ekuivalen Rp500.000,-", 2),
                              rowtext("Minimum Setoran Selanjutnya",
                                  "Rp5.000,-", 2),
                              rowtext("Minimum Saldo rata-rata per bulan",
                                  "Rp150.000,-", 2),
                              rowtext("Denda dibawah Saldo Minimum",
                                  "Rp5.000,-", 2),
                              rowtext("Biaya Pengelolaan Rekening Per bulan",
                                  "Rp11.000,-", 2),
                              ...
                              listedText(
                                  "Transaksi dimana saja dan kapan saja dengan aplikasi BNI Mobile Banking\n"),
                              Text(
                                  "Apabila sudah memiliki fisik Kartu Debit BNI:",
                                  style: medium12),
                              listedText("Tarik Tunai sampai Rp 5 juta/hari"),
                              listedText(
                                  "Limit transaksi belanja sampai Rp 50 juta/hari"),
                              listedText(
                                  "Kenyamanan transaksi pembayaran belanja online diberbagai merchant online/e-commerce kapanpun dengan mudah dan aman dengan Kartu Debit BNI Chip Mastercard© dengan teknologi 3D Secure"),
                            ],
                          ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              rowtext(
                                  "Biaya Pengelolaan Rekening Per bulan",
                                  "Bebas biaya selama 6 bulan pertama. Bulan selanjutnya dikenakan biaya sebesar Rp10.000,-/bulan",
                                  1),
                              rowtext("Biaya Penggantian Buku", "Rp0,-", 2),
                              rowtext(
                                  "Biaya Penutupan Rekening", "Rp25.000,-", 2),
                              rowtext("Biaya Administrasi Kartu Debit",
                                  "Rp7.500,-", 2),
                              Divider(thickness: 2),
                              Padding(
                          ...
                          Column(
                            children: [
                              ...
                              rowtext(
                                  "≥ Rp 5 Juta s/d Rp 100 Juta", "0.75%", 1),
                              rowtext(
                                  "> Rp 100 Juta s/d Rp 1 Milyar", "1.00%", 1),
