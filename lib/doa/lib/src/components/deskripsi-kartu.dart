  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        listedText(
            'Kenyamanan dalam bertransaksi dengan teknologi Chip dan 6 digit PIN\n',
        ...
        rowtext(
          ...
          Column(
            children: [
              pointedText(
                  '',
                  'Internet Banking, SMS Banking, Phone Banking, Mobile Banking dan QRIS',
                  true),
              pointedText(
                  '', 'Transaksi Online (3D Secure dan BNI Debit)', true),
            ],
          ),
        ),
        Text(
