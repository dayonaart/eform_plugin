                              ...
                              children: [
                                ...
                                CustomButtonWhiteWidgets(
                                  onPressed: !isMultiple
                                      ...
                                      : () {
                                          if (item.key == 0) {
                                            // if (dataFileController
                                            //         .livenessType ==
                                            //     'Vj') {
                                            //   dataFileController.startLiveness(
                                            //       context,
                                            //       isOnlyLiveness: true);
                                            // } else {
                                            dataFileController
                  ...
                  body: CustomBodyWidgets(
                    content: Column(
                      children: [
                        ...
                        dataFileController.isLivenessDone &&
                                dataFileController.isKtpDone
                            ? getRowPhoto(
                                function: () {
                                  // if (dataFileController.livenessType == 'Vj') {
                                  //   dataFileController.startLiveness(context);
                                  // } else {
                                  dataFileController.startZolozLiveness();
                                  // }
                                },
                                isMultiple: true,
                                base64List: [
                            ...
                            : photoButton("Ambil Foto Wajah & KTP", context,
                                ...
                                showDialog(
                                    ...
                                    builder: (context) {
                                      return Container(
                                        color:
                                            Color(0xFF5E5E5E).withOpacity(0.75),
                      ...
                      """),
                            ...
                            ? getRowPhoto(
                                function: () {
                                  Get.toNamed(Routes().tandatangan)!.then(
                                      (val) => val
                                          ? dataFileController.checkFileDone()
                                          : null);
                                },
                                base64List: [
                                  dataFileController.signaturePhoto!
                                ],
                              )
                            : photoButton(
                                "Foto tanda tangan diatas kertas putih",
                                context, () {
                                Get.toNamed(Routes().tandatangan)!.then((val) =>
                                    val
                                        ? dataFileController.checkFileDone()
                                        : null);
                              }),
                        ...
                        dataFileController.isNpwpDone
                            ? getRowPhoto(
                                function: () {
                                  Get.toNamed(Routes().ktpnpwp)!.then((val) =>
                                      val
                                          ? dataFileController.checkFileDone()
                                          : null);
                                },
                            ...
                            : photoButton("Ambil Foto e-KTP", context, () {
                                Get.toNamed(Routes().ktpnpwp)!.then((val) => val
                                    ? dataFileController.checkFileDone()
                                    : null);
                              }),
                        SizedBox(height: 100),
      ...
      children: [
        Padding(
          ...
          child: isDone
              ...
              : Image.asset(icon, width: 30, package: "eformplugin"),
        ),
        Expanded(
          child: InkWell(
            onTap: function,
            child: Container(
              ...
              child: Row(
                children: [
                  Image.asset("assets/images/simpanan-camera-icon.png",
                      package: "eformplugin"),
                  SizedBox(
                    width: 10,
                  ),
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              } else if (Value.captchaController.text !=
                                  Value.randomString) {
                                getAlert(
                                  Container(
                                    child: Column(
