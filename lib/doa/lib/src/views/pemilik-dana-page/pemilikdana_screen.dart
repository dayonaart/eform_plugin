...
import 'package:eformplugin/doa/lib/src/models/pemilik-dana-model.dart';
...
final regexWordSymbol = RegExp(
    r'^[a-zA-Z]+$'); //Check Just Word and symbol - , . /).  ex: Jln. Atok Dalang
final regexNumber = RegExp(r'^[0-9]*$');

class _PemilikDanaScreenState extends State<PemilikDanaScreeen> {
  PemilikDanaController pemilikDanaController =
            ...
            child: Scaffold(
              ...
              body: CustomBodyWidgets(
                ...
                headerTextDetail: Text(
                    "Lengkapi detail informasi mengenai sumber dana Anda.",
                    style: infoStyle),
              ),
