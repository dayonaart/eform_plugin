...
import 'package:eformplugin/doa/lib/BusinessLogic/Registrasi/CreateMbankController.dart';
                ...
                CustomBodyWidgets(
                  ...
                  content: Column(
                    children: [
                      ...
                      rowtext('Tanggal Registrasi',
                          DateFormat('dd MMMM yyyy').format(DateTime.now())),
                      rowtext('Waktu Registrasi',
                          DateFormat('HH:mm:ss').format(DateTime.now())),
                      rowtext('User ID ',
                          createMbankController.inputUserIdController.text),
                  ...
                  headerTextDetail: RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text:
                                "Pendaftaran BNI Mobile Banking Anda berhasil!",
                            style: labelText.copyWith(
                                fontWeight: FontWeight.w600)),
                      ],
                    ),
