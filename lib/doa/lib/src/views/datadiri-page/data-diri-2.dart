...
import 'package:eformplugin/doa/lib/BusinessLogic/Registrasi/DataDiri1Controller.dart';
...
import 'package:eformplugin/doa/lib/src/components/custom_body.dart';
import 'package:eformplugin/doa/lib/src/components/custom_dropdown_search.dart';
import 'package:eformplugin/doa/lib/src/components/custom_textfromfield.dart';
...
import 'package:eformplugin/doa/lib/src/views/register/work/work_detail/textform_custom.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropDownWidgets(
                ...
                validator: (val) =>
                    dataDiri2Controller.validatorFormField(val, "country"),
                onTap: () async =>
                    await dataDiri2Controller.dropDownOntap("country", context),
                label: 'Negara'),
          ),
          ...
          Padding(
            ...
            child: CustomTextFromField(
              ...
              autovalidateMode: AutovalidateMode.onUserInteraction,
              validator: (val) =>
                  dataDiri2Controller.validatorFormField(val, "domicile"),
            ),
          ),
        ],
      );
              ...
              child: CustomBodyWidgets(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomTextFromField(
                          ...
                          controller:
                              dataDiri2Controller.publisherCityController,
                          autovalidateMode: AutovalidateMode.onUserInteraction,
                          validator: (val) =>
                              _.validatorFormField(val, "publiserCity"),
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: CustomDropDownWidgets(
                            ...
                            validator: (val) =>
                                _.validatorFormField(val, 'gender'),
                            controller: dataDiri2Controller.genderController,
                            onTap: () async =>
                                await _.dropDownOntap("gender", context),
                            label: 'Jenis Kelamin'),
                      ),
                      _title('Agama'),
                      Padding(
                        ...
                        child: CustomDropDownWidgets(
                          autovalidateMode: AutovalidateMode.onUserInteraction,
                          validator: (val) =>
                              _.validatorFormField(val, 'religion'),
                          controller: dataDiri2Controller.religionController,
                          label: 'Agama',
                          onTap: () async =>
                              await _.dropDownOntap("religion", context),
                        ),
                      ),
                      _title('Email'),
                      Padding(
                        ...
                        child: CustomTextFromField(
                            ...
                            autovalidateMode:
                                AutovalidateMode.onUserInteraction,
                            validator: (val) =>
                                _.validatorFormField(val, "email")),
                      ),
                            ...
                            children: [
                              Expanded(
                                child: CustomTextFromField(
                                  ...
                                  controller:
                                      dataDiri2Controller.prefixLandlineNumber,
                                  autovalidateMode: dataDiri2Controller
                                              .landlineNumberController.text ==
                                          ''
                                      ? AutovalidateMode.always
                                      : AutovalidateMode.onUserInteraction,
                                  validator: (val) =>
                                      _.validatorFormField(val, "landlineCode"),
                                ),
                              ),
                              SizedBox(
                              ...
                              Expanded(
                                ...
                                child: CustomTextFromField(
                                  ...
                                  // ],
                                  keyboardType: TextInputType.number,
                                  controller: dataDiri2Controller
                                      .landlineNumberController,
                                  autovalidateMode: dataDiri2Controller
                                              .prefixLandlineNumber.text ==
                                          ''
                                      ? AutovalidateMode.always
                                      : AutovalidateMode.onUserInteraction,
                                  validator: (val) => _.validatorFormField(
                                      val, "landlineNumber"),
                                ),
                              ),
                            ],
                      ...
                      Padding(
                        ...
                        child: CustomDropDownWidgets(
                            autovalidateMode:
                                AutovalidateMode.onUserInteraction,
                            validator: (val) =>
                                _.validatorFormField(val, 'marital'),
                            controller:
                                dataDiri2Controller.maritalStatusController,
                            onTap: () async =>
                                await _.dropDownOntap("marital", context),
                      ...
                      Padding(
                        ...
                        child: CustomTextFromField(
                          ...
                          autovalidateMode: AutovalidateMode.onUserInteraction,
                          validator: (val) =>
                              _.validatorFormField(val, "motherName"),
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: CustomTextFromField(
                          ...
                          autovalidateMode: AutovalidateMode.onUserInteraction,
                          validator: (val) =>
                              _.validatorFormField(val, "address"),
                        ),
                      ),
                      Row(
                        children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: CustomTextFromField(
                                  ...
                                  keyboardType: TextInputType.number,
                                  controller:
                                      dataDiri2Controller.hamletController,
                                  autovalidateMode:
                                      AutovalidateMode.onUserInteraction,
                                  validator: (val) =>
                                      _.validatorFormField(val, "rw"),
                                ),
                              ),
                            ],
                          ),
                      ...
                      Padding(
                        ...
                        child: CustomDropDownWidgets(
                            autovalidateMode:
                                AutovalidateMode.onUserInteraction,
                            validator: (val) =>
                                _.validatorFormField(val, 'province'),
                            controller: dataDiri2Controller.provinceController,
                            onTap: () async =>
                                await _.dropDownOntap("province", context),
                            label: 'Provinsi'),
                      ),
                      ...
                      Padding(
                        ...
                        child: CustomDropDownWidgets(
                            autovalidateMode:
                                AutovalidateMode.onUserInteraction,
                            validator: (val) =>
                                _.validatorFormField(val, 'district'),
                            controller:
                                dataDiri2Controller.subDistrictController,
                            onTap: () async =>
                                await _.dropDownOntap("district", context),
                            label: 'Kecamatan'),
                      ),
                      ...
                      Padding(
                        ...
                        child: CustomTextFromField(
                          inputFormater: [UpperCaseTextField()],
                          controller:
                              dataDiri2Controller.urbanVillageController,
                          autovalidateMode: AutovalidateMode.onUserInteraction,
                          validator: (val) =>
                              _.validatorFormField(val, "village"),
                        ),
                      ),
                      _title('Kode Pos'),
                      Padding(
                        ...
                        child: CustomDropDownWidgets(
                            autovalidateMode:
                                AutovalidateMode.onUserInteraction,
                            validator: (val) =>
                                _.validatorFormField(val, 'postalCode'),
                            controller:
                                dataDiri2Controller.postalCodeController,
                            onTap: () async =>
                                await _.dropDownOntap("postalCode", context),
                            label: 'Kecamatan'),
                      ),
                      if (dataDiri2Controller.prefs!.getString('indexPosisi') ==
                          '2')
                        overseasField()
                    ],
                  ),
                ...
                headerTextDetail: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: 'Pastikan semua data diri ', style: infoStyle),
                      TextSpan(
              ...
              ontap: !_.validationButton
                  ...
                  : () {
                      if (_.formKey.currentState!.validate())
                        dataDiri2Controller.checkProgress();
                    },
            ),
