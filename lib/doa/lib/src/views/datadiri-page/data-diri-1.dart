...
class _DataDiri1State extends State<DataDiri1> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async =>
          await dataDiri1Controller.willPop(dataController.prefs),
          ...
          child: Scaffold(
            appBar: AppBar(
              leading: LeadingIcon(
                context: context,
                onPressed: () =>
                    dataDiri1Controller.onBackButton(dataController.prefs),
              ),
              elevation: 0,
              centerTitle: true,
              title: Text(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFromField(
                          ...
                          validator: (value) =>
                              dataDiri1Controller.validatorField('nik'),
                        ),
                        SizedBox(height: 15),
                        ...
                        CustomTextFromField(
                          ...
                          autovalidateMode: dataDiri1Controller.checkErrorCode(
                              "name",
                              dataController.prefs.getString('errorCode')!),
                          validator: (value) =>
                              dataDiri1Controller.validatorField("name"),
                        ),
                        SizedBox(height: 15),
                        ...
                        CustomTextFromFieldDate(
                          firstDate: dataDiri1Controller.firstDate,
                          ...
                          autovalidateMode: dataDiri1Controller.checkErrorCode(
                              ...
                              dataController.prefs.getString('errorCode')!),
                          validator: (value) =>
                              dataDiri1Controller.validatorField("dob"),
                          hintText: 'DD/MM/YYYY',
                        ),
                        SizedBox(height: 15),
                        ...
                        CustomTextFromField(
                          ...
                          autovalidateMode: dataDiri1Controller.checkErrorCode(
                              ...
                              dataController.prefs.getString('errorCode')!),
                          validator: (value) =>
                              dataDiri1Controller.validatorField("birthPlace"),
                        ),
                        SizedBox(
                          height: 15,
                        ),
