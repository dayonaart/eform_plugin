...
import 'package:eformplugin/doa/lib/src/components/button-wrap.dart';
...
import 'package:eformplugin/doa/lib/src/models/kantorCabang_model.dart';
...
class PemilihanCabangIndonesiaPage extends StatefulWidget {
  @override
  State<PemilihanCabangIndonesiaPage> createState() =>
      _PemilihanCabangIndonesiaPageState();
}

class _PemilihanCabangIndonesiaPageState
    extends State<PemilihanCabangIndonesiaPage> {
    ...
    Widget indicator() {
      return Container(
          margin: EdgeInsets.fromLTRB(
              defaultMargin, defaultMargin, defaultMargin, 32),
          child: Column(
                        ...
                        onTap: () {
                          if (data.office.text.isNotEmpty) {
                            ...
                            Clipboard.setData(ClipboardData(
                                text: data.office.text.toString()));
                          }
                        },
                        maxLines: 3,
                        readOnly: true,
