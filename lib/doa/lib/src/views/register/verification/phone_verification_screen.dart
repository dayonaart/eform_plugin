...
import 'package:eformplugin/doa/lib/src/views/register/verification/description_verification.dart';
      ...
      return CustomScrollView(
        slivers: [
          SliverList(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Center(
                      child: Text(
                          "Verifikasi Nomor ${data.numberPhone}\nPastikan data Anda Sesuai",
            ...
            Container(
              margin:
                  EdgeInsets.only(top: 40, left: 24, right: 24, bottom: 245),
