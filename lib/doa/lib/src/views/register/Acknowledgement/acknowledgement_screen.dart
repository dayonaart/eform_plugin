                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Clipboard.setData(ClipboardData(
                            text: Get.find<CreatePinController>()
                                .getCardModelResponse
                                ?.accountNum as String));
                      },
                      child: Row(children: [
                        Text(
                          (Get.find<CreatePinController>()
                                      .getCardModelResponse
                                      ?.accountNum ==
                                  null)
                              ? ''
                              : '${Get.find<CreatePinController>().getCardModelResponse?.accountNum}',
                          style: infoStyle.copyWith(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                              flex: 2,
                              child:
                                  Text(data.attributeAck[i], style: infoStyle)),
                          Expanded(
                            flex: 3,
                            child: Text(
                              data.valueAck[i],
