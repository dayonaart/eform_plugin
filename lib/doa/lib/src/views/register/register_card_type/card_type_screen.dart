...
import 'package:eformplugin/doa/lib/src/components/deskripsi-kartu.dart';
...
import 'package:eformplugin/doa/lib/src/views/register/register_card_type/card_type_prefs.dart';
...
class CaraouselWithListWidgets extends StatefulWidget {
  ...
  @override
  State<CaraouselWithListWidgets> createState() =>
      _CaraouselWithListWidgetsState();
}
...
class _CaraouselWithListWidgetsState extends State<CaraouselWithListWidgets> {
  ...
  List<Widget> listKartu = [
    ...
    //   ),
    // ),
    Image.asset("assets/images/simpanan-kartu-debit-silver.png",
        height: 168, width: 264, package: "eformplugin"),
    Image.asset("assets/images/simpanan-kartu-debit-batik-air.png",
        height: 168, width: 264, package: "eformplugin"),
  ];
  ...
  initAll() {
    ...
    } else if (CardTypePrefs.indexValue != null ||
        CardTypePrefs.indexValue!.isNotEmpty) {
            ...
            options: CarouselOptions(
              onPageChanged: ((index, reason) {
                setState(() {
                  ...
                  indexAwal = index;
                  if (index == 0) {
                    cardTypePrefs.setCardTypePrefs("13", "1",
                        "BNI Card Silver Virtual", prefs!, index.toString());
                  }
                  if (index == 1) {
                    cardTypePrefs.setCardTypePrefs(
                        "54",
                        "3",
                        "Kartu Debit BNI Batik Air Virtual",
                        prefs!,
                        index.toString());
                  }
                });
