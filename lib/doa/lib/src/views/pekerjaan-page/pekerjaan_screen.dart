            ...
            child: Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomDropDownWidgets(
                          ...
                          label: '',
                          validator: (value) =>
                              _.dropDownOnChange(value, "salary"),
                        ...
                        CustomDropDownWidgets(
                          ...
                          label: 'Pilih Posisi',
                          validator: (value) =>
                              _.dropDownOnChange(value, "sourceFund"),
                          onTap: () async =>
                              await _.onTap("sourceFund", context),
                        ),
                        SizedBox(
                          height: 15,
                        ),
                        if (_.sourceOfFund.text == "LAINNYA")
                          sumberDanaLainnya(),
                        RichText(
                          text: TextSpan(
                            style: infoStyle,
                        ...
                        CustomDropDownWidgets(
                          ...
                          label: '',
                          validator: (value) =>
                              _.dropDownOnChange(value, "estimatedTransaction"),
                          onTap: () async =>
                              await _.onTap("estimatedTransaction", context),
                        ),
                        SizedBox(height: 15),
                        ...
                        CustomDropDownWidgets(
                          ...
                          label: 'Pilih Posisi',
                          validator: (value) => _.dropDownOnChange(
                              value, "destinationTransaction"),
                          onTap: () async =>
                              _.onTap("destinationTransaction", context),
                        ),
                        SizedBox(height: 100),
                      ],
                    )),
              ...
              floatingActionButton: ButtonCostum(
                ...
                ontap: !_.validationButton
                    ? null
                    : () async =>
                        await _.submit(_.formKey.currentState!.validate()),
              ),
            ),
          ),
        );
