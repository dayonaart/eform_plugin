import 'package:eformplugin/doa/lib/BusinessLogic/Registrasi/AlamatController.dart';
import 'package:eformplugin/doa/lib/service/preferences-alamat-luar-indonesia.dart';
import 'package:eformplugin/doa/lib/src/components/form-decoration.dart';
...
import 'package:eformplugin/doa/lib/src/models/alamat-luar-indonesia.dart';
          ...
          ontap: () {
            if (formGlobalKey.currentState!.validate()) {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const PekerjaanScreeen()));
            }
          },
        ),
      );
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        textFormField(false, data.alamatController, () {},
                            (value) {
                          if (value!.isEmpty) {
                        ...
                        textFormField(
                            false, data.desaKelurahanController, () {},
                            (value) {
                          if (value!.isEmpty) {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      textFormField(
                          false, data.alamatDomisilinController, () {},
                          (value) {
                        if (value!.isEmpty) {
                                  ...
                                  content: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Mohon Maaf',
                                        style:
                                            blackRoboto.copyWith(fontSize: 18),
                                      ),
                                      seperator(0.025),
                                      const Text(
