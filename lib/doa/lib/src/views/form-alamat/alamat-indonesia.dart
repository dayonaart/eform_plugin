...
import 'package:eformplugin/doa/lib/service/preferences-alamat-indonesia.dart';
...
import 'package:eformplugin/doa/lib/src/models/alamat-indonesia.dart';
import 'package:eformplugin/doa/lib/src/views/datadiri-page/data-diri-2.dart';
          ...
          ontap: () {
            ...
            if (formGlobalKey.currentState!.validate()) {
              ...
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => PekerjaanScreeen()));
            } else {
              print("Coba");
            }
          },
