...
import 'package:eformplugin/doa/lib/src/components/countdown.dart';
...
import 'package:eformplugin/doa/lib/src/models/send-otp-model.dart';
...
class _OTPScreenState extends State<OTPScreen>
  ...
  void initState() {
    super.initState();
    otpController.messageHeaderSendOtp = false;
    otpController.isHide = true;
          ...
          child: Scaffold(
            ...
            body: Form(
              ...
              child: CustomBodyWidgets(
                marginleft:
                    (Get.find<PhoneVerifyController>().otpsender == 'SMS')
                        ? 22
                        : 24,
                marginright:
                    (Get.find<PhoneVerifyController>().otpsender == 'SMS')
                          ...
                          GestureDetector(
                            onTap: () async {
                              if (_.isHide == false) {
                                ...
                                // print(_.idNumber);
                                if (Get.find<PhoneVerifyController>()
                                        .otpsender ==
                                    'Whatsapp') {
                                  await _.prefs
                                      ?.setString('otpSender', 'Whatsapp');

                                  // print(
                                  //     'Ini Otp Sender : ${_.prefs!.getString('otpSender').toString()}');
                                } else {
                                  await _.prefs?.setString('otpSender', 'SMS');

                                  // print(
                                  //     'Ini Otp Sender : ${_.prefs!.getString('otpSender').toString()}');
                                }
                                await _.submitSendOtp();
                                if (otpController.messageHeaderSendOtp ==
                                    false) {
                        ...
                        children: [
                          GestureDetector(
                            onTap: () async {
                              ...
                              //     'Ini Otp Sender : ${_.prefs!.getString('otpSender').toString()}');
                              // print(
                              //     'ini otp sender dari controller : ${Get.find<PhoneVerifyController>().otpsender}');
                            },
                            child: Text(
                              (Get.find<PhoneVerifyController>().otpsender ==
                                      'Whatsapp')
                                  ? "Kirim ulang kode OTP melalui SMS"
                      ...
                      Padding(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(style: labelTextBlue, children: [
                            ...
                            TextSpan(
                                text:
                                    "nomor handphone Anda aktif dan memiliki pulsa ",
                                style: labelTextBlueBold),
                            TextSpan(
                                text: "untuk pengiriman OTP melalui SMS atau "),
                            TextSpan(
                                text: "terhubung dengan jaringan internet ",
                                style: labelTextBlueBold),
                            TextSpan(
                                text: "untuk pengiriman OTP melalui WhatsApp."),
                          ]),
                        ),
                      )
                    ],
                ...
                headerTextDetail: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text:
                              "Kode OTP dikirimkan ke nomor +${_.phoneNumber}",
                          style:
                              labelText.copyWith(fontWeight: FontWeight.w400))
                    ],
                  ),
                ),
              ),
            ...
            floatingActionButton: ButtonCostum(
                ...
                ontap: !_.validationButton
                    ? null
                    : () async => await _.createAccountDio()),
