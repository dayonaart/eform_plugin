...
import 'package:eformplugin/doa/lib/src/views/home-page/home-screen.dart';
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(
                                top: 10, bottom: 18, left: 15, right: 20),
                            child: Row(
                              children: [
                                isRequirementAccept
                                    ? SvgPicture.asset(
  ...
  Widget getDropDownContainer(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        padding: EdgeInsets.only(
            left: 24, right: 24, top: text1 == 'A. ' ? 32 : 24, bottom: 24),
        child: Column(
          children: [
            Row(
              children: [
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: pointedText(
                  '1.',
                  'e-Statement tidak diterima atau diterima namun tidak sempurna.',
                  false),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 15),
              child: pointedText(
                  '2.', 'Terdapat perubahan data alamat e-mail.', false),
            ),
            pointedText(
                '5.',
