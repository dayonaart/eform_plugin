...
import 'package:eformplugin/doa/lib/src/components/custom_intl_phone/custom_intl_country.dart';
...
import 'package:eformplugin/doa/lib/src/models/posisi_list.dart';
import 'package:eformplugin/doa/lib/src/utility/Routes.dart';
import 'package:eformplugin/doa/lib/src/views/syarat-dan-ketentuan/syarat-dan-ketentuan.dart';
...
class _RegisterNomorPageAltState extends State<RegisterNomorPageAlt> {
  RegistrasiNomorController numberRegisterController =
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RegistrasiNomorController>(builder: (data) {
      return GestureDetector(
          ...
          child: WillPopScope(
            onWillPop: () async {
              Get.off(() => SyaratDanKetentuanPage(),
            ...
            child: MediaQuery.removePadding(
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  elevation: 0,
                  iconTheme:
                      IconThemeData(color: Color.fromRGBO(51, 51, 51, 1)),
                      ...
                      : () {
                          if (data.formKey.currentState!.validate()) {
                            ...
                            if (data.bodyNumberPhone.text.length < 8 ||
                              ...
                              if (data.positionController.text ==
                                  "Luar Indonesia") {
                                print(data.bodyNumberPhone.text);
                                numberRegisterController.saveSharedPref();
                      ...
                      content: Column(
                        ...
                        children: [
                          ...
                          CustomDropDownWidgets(
                            ...
                            label: 'Pilih Posisi',
                            onTap: () async {
                              numberRegisterController.result =
                                  await showDialog(
                              ...
                              if (numberRegisterController.result!.id
                                      .toString() ==
                                  "1") {
