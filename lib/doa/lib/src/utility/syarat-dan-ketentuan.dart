const String requirmentTitle =
    "A. SYARAT DAN KETENTUAN REKENING TABUNGAN PERORANGAN";
const String requirmentContent = """
  ...
  <h4>I. Rekening</h4>
    <ol>
        ...
        <li>Jenis-jenis Rekening adalah Tabungan.</li>
    ...
    <ol>
      ...
      <li>Dana yang disetorkan/dipergunakan/ditransaksikan pada Bank tidak berasal dari/untuk tujuan tindak pidana pencucian uang (money laundering).</li>
      <li>Setiap Transaksi yang menggunakan surat berharga/warkat kliring dan sarana perbankan lainnya berlaku pula ketentuan perundang-undangan yang mengatur tentang hal tersebut.</li>
      ...
      <li>Apabila Rekening dibuka dalam mata uang asing maka penarikan dana dalam mata uang asing yang sama tergantung pada ketersediaan mata uang asing tersebut pada Bank dan tunduk pada ketentuan Bank mengenai komisi sebagaimana yang tertuang dalam media resmi Bank.</li>
      ...
      <li>Setoran dalam mata uang kertas atau mata uang asing yang sama akan diberlakukan dengan cara sesuai dengan peraturan dan ketentuan yang tertuang dalam media resmi Bank.</li>
    ...
    <ol>
      ...
      <li>Dalam hal kartu ATM atau perangkat fasilitas Transaksi Bank melalui sarana elektronik/e-Banking (telepon seluler, BNI e-Secure/m-Secure, dsb) hilang atau terjadi permasalahan atas penggunaan fasilitas e-Banking, maka Nasabah wajib memberitahukan kepada Bank, melalui Kantor Cabang BNI terdekat atau BNI Call di 1500046 atau melalui ponsel di (021)1500046/68888.</li>
    ...
    <h5>A. Tabungan</h5>
    <ol>
      <li>Sebagai bukti kepemilikan Rekening Tabungan, Bank menerbitkan Buku Tabungan, Kartu Debit BNI, atau Rekening Koran Elektronik (e-statement) yang ditetapkan oleh Bank dan bukti tersebut harus dipegang/disimpan Nasabah.</li>
      ...
      <li>Nasabah wajib memelihara saldo minimum yang dipersyaratkan oleh Bank sesuai jenis tabungannya. Nasabah akan dikenakan denda yang besarnya ditentukan Bank apabila saldo Tabungan dibawah saldo minimum yang saat ini berlaku maupun apabila terdapat perubahan. Ketentuan mengenai saldo minimum dan pengenaan denda yang dikenakan tertuang dalam media resmi Bank. Perubahan nominal saldo minimum atau denda ditetapkan oleh Bank dan akan diberitahukan kepada nasabah melalui media resmi Bank.</li>
      <li>Catatan mutasi Transaksi Rekening Tabungan menggunakan Buku Tabungan, Rekening Koran elektronik (e-Statement) yang ditentukan oleh Bank. Dalam hal dipergunakan Buku Tabungan maka mutasi Transaksi Rekening Tabungan agar selalu di update (dicetak). Dalam hal laporan mutasi Transaksi Rekening dilakukan melalui pengiriman email oleh Bank (e-Statement), maka Nasabah wajib segera memberitahukan kepada Bank jika terdapat perubahan alamat email, dan perubahan tersebut efektif berlaku setelah diterima dan/atau disetujui Bank.</li>
    ...
    <h5>B. Rekening Koran Elektronik (E-Statement)</h5>
    <ol>
      <li>Bagi produk yang menggunakan sarana mutasi transaksi Rekening Koran Elektronik (e-Statement) maka Bank akan menerbitkan laporan berkala berupa Rekening Koran Elektronik (e-Statement)</li>
      <li>Dengan menggunakan layanan e-Statement, maka Nasabah menyetujui bahwa mutasi transaksi rekening akan dikirimkan ke alamat e-mail yang telah terdaftar pada sistem Bank.</li>
      <li>Nasabah bertanggung jawab terhadap adanya keterlambatan penerimaan, tidak diterimanya e-mail dan/atau kegagalan pengiriman e-mail yang disebabkan oleh kesalahan pemberian data alamat e-mail kepada Bank, perubahan alamat e-mail yang tidak diberitahukan kepada Bank, tidak dapat diaksesnya e-mail Nasabah karena suatu sebab (antara lain karena terblokir) dan kegagalan sistem Bank yang berada di luar kendali Bank.</li>
      <li>Nasabah setuju bahwa Bank tidak berkewajiban untuk meneliti, menyelidiki keabsahan/kebenaran atas data alamat e-mail Nasabah dan/atau memastikan ketepatan telah diterimanya e-Statement oleh Nasabah. Karenanya Nasabah wajib menghubungi Bank apabila :</li>
      <ol>
        <li>e-Statement tidak diterima atau diterima namun tidak sempurna.</li>
        <li>Terdapat perubahan data alamat e-mail.</li>
      </ol>
      <li>Dalam hal terdapat sanggahan atas segala sesuatu yang termuat dalam e-Statement tersebut harus dilakukan dalam waktu 30 (tiga puluh) hari kalender sejak e-Statement disampaikan atau dikirim oleh Bank kepada Nasabah. Bank berwenang untuk melakukan koreksi terhadap mutasi dan saldo rekening bila terjadi kekeliruan pembukuan oleh Bank.</li>
      <li>Dalam hal e-Statement telah dikirimkan ke alamat email Nasabah namun gagal terkirim karena alamat email yang disampaikan nasabah salah yang terjadi selama 3 (tiga) bulan berturut-turut, maka Bank tidak akan mengirimkan kembali e-Statement tersebut.</li>
      <li>Bagi Nasabah yang pengiriman Rekening Korannya dihentikan sebagaimana dimaksud butir B.6, maka Nasabah tersebut dapat meminta kepada Bank agar Rekening Korannya dikirimkan kembali setiap bulan dengan menyampaikan permohonan secara tertulis dan disampaikan secara langsung ke Cabang Pembuka Rekening.</li>
    </ol>
    <h5>C. Fasilitas Transaksi Perbankan Melalui Sarana Elektronik (e-Banking)</h5>
    <ol>
      <li>Bank menyediakan fasilitas bagi Nasabah untuk dapat melakukan Transaksi perbankan melalui sarana elektronik (e-Banking), yaitu:</li>
      <ol type="a">
        ...
        <li>BNI Phone Banking adalah fasilitas Transaksi perbankan 24 (dua puluh empat) jam dengan memberikan perintah Transaksi kepada Bank melalui telepon.</li>
        <li>BNI SMS Banking adalah salah satu fasilitas transaksi perbankan 24 (dua puluh empat) jam melalui fasilitas e-Banking dari BNI untuk mengakses rekening Nasabah melalui Telepon Selular yang dimilikinya (provider jaringan GSM dan CDMA) dengan cara mengirimkan SMS (Short Message Service) perintah dalam format tertentu ke nomor 3346. BNI SMS Banking juga dapat diakses melalui telepon seluler oleh Nasabah dengan mendownload aplikasinya terlebih dahulu. </li>
        <li>BNI Internet Banking adalah salah satu fasilitas transaksi perbankan 24 (dua puluh empat) jam melalui fasilitas e-Banking dari BNI untuk mengakses rekening yang dimiliki Nasabah melalui jaringan internet dengan menggunakan perangkat lunak browser pada komputer dan telepon seluler.</li>
        <li>BNI Mobile Banking adalah layanan e-Banking dari Bank yang dapat diakses melalui telepon seluler oleh Nasabah dengan men-download aplikasinya terlebih dahulu.</li>
      </ol>
      <li>Jenis Rekening simpanan perorangan yang dapat diberikan fasilitas e-Banking ditetapkan oleh Bank.</li>
      <li>Untuk dapat menggunakan fasilitas e-Banking, Nasabah harus memiliki tanda pengguna dan nomor identifikasi pribadi fasilitas e-Banking, yaitu:</li>
      <ol type="a">
        ...
        <li>BNI Phone Banking berupa user id (berupa nomor BNI Debit Card) dan PIN BNI Phone Banking.</li>
      ...
      <li>Instruksi yang disampaikan oleh Nasabah menggunakan tanda pengguna dan nomor identifikasi pribadi fasilitas e-Banking mempunyai kekuatan hukum yang sama dengan perintah tertulis yang ditandatangani oleh Nasabah.</li>
      <li>Tanda pengguna dan nomor identifikasi pribadi fasilitas e-Banking hanya diketahui dan menjadi rahasia pribadi Nasabah. Setiap penyalahgunaan tanda pengenal nomor identifikasi pribadi fasilitas e-Banking menjadi tanggung jawab dan resiko Nasabah sepenuhnya.</li>
      <li>Untuk Transaksi yang diinstruksikan melalui BNI Phone Banking, Bank berhak melakukan verifikasi dan identifikasi Nasabah sebelum menggunakan fasilitas tersebut berdasarkan tata cara yang ditentukan dari waktu ke waktu oleh Bank.</li>
      <li>Semua Transaksi yang dilakukan melalui fasilitas e-Banking akan mendebet dan tercatat pada Rekening yang terdaftar pada fasilitas e-Banking.</li>
      ...
      <li>Jenis Transaksi perbankan yang dapat dilakukan melalui fasilitas e-Banking ditentukan oleh Bank sebagaimana tertuang dalam Syarat dan Ketentuan Produk Elektronik Banking dan media resmi Bank. Perubahan atas jenis Transaksi dimaksud akan diberitahukan kepada nasabah dari waktu ke waktu melalui media resmi Bank. </li>
      <li>Setiap Transaksi melalui fasilitas e-Banking dibatasi nominal dan frekuensinya dengan suatu nominal dan frekuensi maksimum per transaksi dan/atau per hari yang ditentukan oleh Bank atau karena sebab lain yang ditentukan oleh Bank sebagaimana tertuang dalam Syarat dan Ketentuan Produk Elektronik Banking dan media resmi Bank.</li>
      <li>Untuk setiap Transaksi yang dilakukan melalui fasilitas e-Banking, Nasabah akan dibebankan biaya dan tarif sesuai dengan ketentuan yang berlaku di Bank sebagaimana yang tertuang dalam Syarat dan Ketentuan Produk Elektronik Banking dan media resmi Bank.</li>
      <li>Nasabah wajib memastikan bahwa perangkat komputer dan/atau telepon seluler yang digunakan untuk mengakses BNI e-Banking, bebas dari semua jenis virus atau bentuk aplikasi-aplikasi lainnya yang dapat merugikan Nasabah.</li>
      <li>Bank sewaktu-waktu dan/atau setiap saat berhak menghentikan setiap fasilitas Elektronik Banking yang diperoleh Nasabah jika Nasabah tidak memenuhi/melanggar ketentuan/kebijakan yang telah ditetapkan oleh Bank sebagaimana tertuang dalam Syarat dan Ketentuan Produk Elektronik Banking dan media resmi Bank dan atau perundang-undangan yang berlaku, atas hal tersebut bank akan menginformasikan penghentian dimaksud kepada Nasabah dalam bentuk dan sarana apapun.</li>
    </ol>
    <h5>D. Fasilitas Pembayaran Tagihan dan Transfer Otomatis</h5>
    <ol>
      ...
      <li>Nasabah bertanggung jawab sepenuhnya atas pemutusan hubungan telepon/listrik/telepon pasca bayar/kartu kredit atau risiko lainnya sebagai akibat tidak dapat dilakukannya pembayaran tagihan atau transfer otomatis karena tidak cukupnya dana pada Rekening Nasabah, Bank belum menerima nilai tagihan yang harus dibayarkan dari penyedia jasa atau akibat kegagalan sistem.</li>
      ...
      <li>Bila Nasabah bermaksud menghentikan fasilitas pembayaran tagihan atau transfer otomatis, maka Nasabah wajib memberitahukan secara tertulis kepada Bank. Apabila Nasabah menggunakan fasilitas Phone Banking maka Nasabah dapat menghubungi BNI Call untuk mengajukan pemberhentian paling lambat 7 (tujuh) hari kerja sebelum dimulainya masa pembayaran fasilitas yang bersangkutan</li>
    </ol>
    ...
    <ol>
      ...
      <li>Dalam hal Rekening Tabungan selama 6 (enam) bulan berturut-turut maupun untuk periode lain yang ditetapkan tidak bermutasi debet maupun kredit selain pendebetan dan pengkreditan yang dilakukan oleh sistem Bank untuk biaya administrasi, pajak, denda dan bunga, maka Rekening Tabungan akan diberi status tidak aktif. Perubahan periode untuk rekening yang diberi status tidak aktif akan diberitahukan oleh Bank kepada Nasabah dalam media resmi Bank.</li>
      <li>Rekening dengan status tidak aktif dikenakan biaya yang besarnya tertuang dalam media resmi Bank.</li>
      <li>Rekening dengan status tidak aktif dapat berubah menjadi Rekening aktif kembali apabila Nasabah melakukan transaksi atas Rekening tersebut baik transaksi setoran, penarikan dan pemindahbukuan melalui Kantor Cabang Bank.</li>
      <li>Bank berhak secara otomatis menutup Rekening Tabungan yang berstatus tidak aktif sebagaimana dimaksud butir VIII.3 di atas dan bersaldo Rp. 0,- (saldo nihil) maupun untuk jumlah saldo tertentu yang dari waktu ke waktu akan diberitahukan oleh Bank kepada Nasabah melalui media resmi Bank.</li>
    ...
    <ol>
      ...
      <li>Bank tidak bertanggung jawab atas terjadinya hal-hal diluar kekuasaan Bank (Force Majeure)</li>
      <li>Bank berwenang melakukan koreksi mutasi dan saldo Rekening Nasabah apabila terjadi kekeliruan pembukuan oleh Bank tanpa berkewajiban memberitahukan alasannya kepada Nasabah.</li>
      <li>Dalam hal salah satu ketentuan dalam Perjanjian ini dinyatakan batal berdasarkan suatu peraturan perundang-undangan, maka pernyataan batal tersebut tidak mengurangi keabsahan atau menyebabkan batalnya persyaratan atau ketentuan lain dalam Perjanjian ini dan oleh karenanya ketentuan lain dalam Perjanjian ini tetap sah dan mengikat.</li>
    </ol>
    <h4>X. Pemberlakuan Ketentuan</h4>
    <ol>
      <li>Bank berhak mengubah Ketentuan Umum dan Persyaratan Pembukaan Rekening ini termasuk ketentuan dan syarat-syarat yang berkaitan dengan produk/fasilitas/jasa yang secara khusus ditetapkan Bank yang menjadi satu kesatuan dan bagian yang tidak terpisahkan dari Ketentuan Umum dan Persyaratan Pembukaan Rekening ini yang akan diinformasikan melalui media resmi Bank sesuai dengan jangka waktu pemberitahuan yang ditetapkan oleh Otoritas Jasa Keuangan.</li>
      <li>Syarat dan ketentuan produk/fasilitas/jasa selengkapnya diatur dalam syarat dan ketentuan masing-masing produk/fasilitas/jasa yang secara khusus ditetapkan oleh Bank meliputi Buku Petunjuk dan Kebijakan Internal Bank lainnya yang merupakan satu kesatuan serta bagian yang tidak terpisahkan dari Ketentuan Umum dan Persyaratan Pembukaan Rekening ini.</li>
      <li>Dalam hal Ketentuan Umum dan Persyaratan Pembukaan Rekening ini bertentangan dengan ketentuan khusus pada masing-masing produk/fasilitas/jasa yang ditetapkan Bank, maka yang berlaku adalah ketentuan khusus dimaksud.</li>
    </ol>
    <h4>XI.	Hukum Yang Berlaku Dan Domisili</h4>
    <ol>
      ...
      <li>Bank dan Nasabah dengan ini sepakat bahwa segala gugatan akan diajukan di Pengadilan Negeri di wilayah hukum dimana Kantor Cabang BNI pembuka Rekening Nasabah berada.</li>
      <li>Penundukan pada domisili tersebut di atas tidak membatasi hak Bank untuk mengajukan gugatan terhadap Nasabah dalam domisili lainnya dalam wilayah Indonesia maupun luar Indonesia.</li>
    </ol>
    <h4>XII. Pernyataan Dan Persetujuan Nasabah</h4>
    <p>Dengan menyetujui aplikasi ini, saya menyatakan bahwa:</p>
    <ol>
      <li>Data Nasabah Perorangan yang diisikan pada Pembukaan Rekening Perorangan ini adalah yang sebenar-benarnya, apabila di kemudian hari terdapat perubahan atas data isian saya tersebut yang tidak saya sampaikan kepada BNI maka saya bertanggung jawab atas segala tuntutan, gugatan dan/atau klaim dari pihak manapun serta dari segala kerugian dan risiko yang mungkin timbul di kemudian hari.</li>
      <li>Bank dapat melakukan pemeriksaan terhadap kebenaran data yang saya berikan dalam pembukaan rekening perorangan ini.</li>
      <li>Bank telah memberikan penjelasan yang cukup mengenai karakteristik produk/fasilitas/jasa yang akan yang akan saya manfaatkan dan saya telah mengerti serta memahami segala konsekuensi pemanfaatan produk/fasilitas/jasa Bank, termasuk manfaat, resiko dan biaya-biaya yang melekat pada produk/fasilitas/jasa tersebut.</li>
      <li>Bank dapat menginformasikan kepada saya mengenai peningkatan fasilitas dan/atau nilai tambah terhadap penggunaan produk dan/atau layanan BNI yang sudah saya miliki, maupun penawaran produk, program, dan layanan baru yang belum saya miliki melalui media, telepon, sms, email dan media lainnya (elektronik maupun non elektronik).</li>
      <li>Saya memberi hak dan wewenang kepada Bank untuk melakukan pemblokiran dan atau penutupan rekening, apabila :</li>
      <ol type="a">
        <li>Saya tidak mematuhi ketentuan Prinsip Mengenal Nasabah (Know Your Customer).</li>
        <li>Dokumen yang saya berikan kepada Bank diketahui dan/atau patut diduga palsu.</li>
        <li>Informasi yang saya sampaikan kepada Bank tidak benar atau diragukan kebenarannya.</li>
        <li>Memiliki sumber dana transaksi yang diketahui dan/atau patut diduga berasal dari hasil tindak pidana.</li>
      </ol>
      <li>Saya memberikan persetujuan kepada Bank untuk memberikan identitas saya kepada pihak lain meliputi anak perusahaan dan perusahaan yang bekerjasama dengan Bank didalam pengembangan produk/layanan/jasa Bank untuk tujuan komersial dan saya telah memahami penjelasaan Bank mengenai tujuan dan konsekuensi dari pemberian identitas tersebut.</li>
      <li>Dalam rangka memenuhi ketentuan Peraturan Pemerintah Republik Indonesia tentang Besaran Nilai Simpanan yang Dijamin Lembaga Penjamin Simpanan (LPS), saya menyatakan setuju dan bersedia menerima resiko bahwa klaim penjaminan atas simpanan tidak akan dibayar apabila simpanan yang saya tempatkan di PT. Bank Negara Indonesia (Persero) Tbk tidak memenuhi ketentuan penjaminan simpanan, atau dinyatakan sebagai Klaim Penjaminan tidak layak dibayar sebagaimana yang telah ditetapkan oleh LPS.</li>
      <li>Dalam hal pihak nasabah pemilik rekening dan pemberi dana dari nasabah pemilik rekening telah memenuhi persyaratan sebagai wajib pajak dan/atau telah memiliki NPWP maka saya menyatakan akan segera menyerahkan NPWP tersebut kepada BNI. Apabila dikemudian hari saya memiliki NPWP atau telah memenuhi persyaratan sebagai Wajib Pajak sesuai dengan ketentuan Peraturan Perundang-undangan yang berlaku, maka saya akan menyerahkan NPWP tersebut kepada BNI</li>
      <li>Saya memberi persetujuan kepada Bank untuk melengkapi dan melakukan pengkinian data (up-date data) berdasarkan data terakhir pada formulir/aplikasi produk dan layanan perbankan, apabila ternyata data yang telah Saya berikan dalam Formulir Pembukaan Rekening ini sudah tidak merupakan data yang terkini lagi</li>
    </ol>
    <p>Dengan menyetujui Formulir Ketentuan Umum dan Persyaratan Pembukaan Rekening ini, saya/kami menyatakan dengan ini menerima dan setuju mengikatkan diri pada semua syarat dan ketentuan umum yang tertuang dalam Formulir ini.</p>
""";

const String penggunaanTitle =
    "B. PERSETUJUAN PENAWARAN PRODUK DAN JASA LAYANAN";
const String penggunaanContent = """
  <ul>
    <li>Bank dapat menginformasikan kepada saya mengenai peningkatan fasilitas dan/atau nilai tambah terhadap penggunaan produk dan/atau layanan BNI yang sudah saya miliki, maupun penawaran produk, program, dan layanan baru yang belum saya miliki melalui media, telepon, sms, email dan media lainnya (elektronik maupun non elektronik).</li>
    <li>Bank dapat memberikan data identitas saya kepada pihak lain meliputi anak perusahaan dan perusahaan yang bekerjasama dengan Bank didalam pengembangan produk/layanan/jasa untuk tujuan komersial dan saya memahami penjelasan bank mengenai tujuan dan konsekuensi dari pemberian identitas tersebut.</li>
  </ul>
""";
