...
import 'package:eformplugin/doa/lib/src/utility/tensor_controller.dart';
...
Widget _cameraPreviewWidget(
    BuildContext context, TensorController _controller) {
  return Column(
    children: [
      Expanded(
              ...
              child: Column(children: [
                ...
                Expanded(
                  child: StackDialog(
                    ...
                    ontap: () async =>
                        await _controller.onTakePictureButtonPressed(),
                  ).show(),
                ),
              ]),
            )),
...
Padding _ktpFacePreview(BuildContext context,
    {double? heigth, double? width, Radius? radius}) {
  return Padding(
