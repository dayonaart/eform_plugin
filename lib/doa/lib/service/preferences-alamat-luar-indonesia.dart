...
class PreferencesAlamatLuarIndonesia {
  Future saveAlamatLuarIndonesia(
      AlamatLuarIndonesiaModel alamatluarIndonesia) async {
  ...
  Future<AlamatLuarIndonesiaModel> getAlamatLuarIndonesia() async {
    ...
    if (preferences.getString('alamat') != null) {
      ...
      return AlamatLuarIndonesiaModel(alamat!, rt!, rw!, provinsi!, kota!,
          kecamatan!, desa!, kodePos!, alamatDomisili!, negaraDomisili!);
    } else {
