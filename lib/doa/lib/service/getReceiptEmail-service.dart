...
class GetReceiptEmailService {
  Future<ReceiptEmailModel> getReceiptEmail(
    ...
    var headers =
        Get.find<DataController>().headerSoap(step: 'Api Get Receipt Email');
    var body = '''
...
''';
    ...
    if (response.statusCode == 200) {
      ...
      var data = jsonDecode(jsondatatoParker)['soapenv:Envelope']
          ['soapenv:Body']['composeResponse']['composeReturn'];
